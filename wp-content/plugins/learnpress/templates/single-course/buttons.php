...
$purchase_button_text = apply_filters( 'learn_press_purchase_button_text', __( 'Comprar este treinamento', 'learnpress' ) );
$enroll_button_text   = apply_filters( 'learn_press_enroll_button_text', __( 'Acessar módulo online', 'learnpress' ) );
