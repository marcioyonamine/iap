...
$review_order_heading = apply_filters( 'learn_press_checkout_review_order_heading', __( 'Comprar treinamento', 'learnpress' ) );
...
<table class="learn-press-checkout-review-order-table">
	<thead>
	<tr>
		<th class="course-name"><?php _e( '<strong>Treinamento</strong>', 'learnpress' ); ?></th>
		<th class="course-total"><?php _e( '<strong>Total</strong>', 'learnpress' ); ?></th>
	</tr>
	</thead>
	<tbody>
	...
	<tr class="cart-subtotal">
		<th><?php _e( 'Sub-total', 'learnpress' ); ?></th>
