...
$payment_heading              = apply_filters( 'learn_press_checkout_payment_heading', __( 'Método de Pagamento', 'learnpress' ) );
$order_button_text            = apply_filters( 'learn_press_order_button_text', __( 'Comprar', 'learnpress' ) );
