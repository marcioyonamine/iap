...
if ( !class_exists( 'LP_Course_Post_Type' ) ) {
	...
	final class LP_Course_Post_Type extends LP_Abstract_Post_Type {
		...
		function register() {
			...
			$labels           = array(
				'name'               => _x( 'Treinamentos', 'Post Type General Name', 'learnpress' ),
				'singular_name'      => _x( 'Treinamento', 'Post Type Singular Name', 'learnpress' ),
				'menu_name'          => __( 'Treinamentos', 'learnpress' ),
				'parent_item_colon'  => __( 'Parent Item:', 'learnpress' ),
				'all_items'          => __( 'Treinamentos', 'learnpress' ),
