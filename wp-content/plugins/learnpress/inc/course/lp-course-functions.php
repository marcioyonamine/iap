	...
	function learn_press_get_nav_course_item( $course_id = null, $item_id = null, $content_only = false ) {
		...
		if ( isset( $nav['back']['link'] ) ) {
			$nav_html .=
				...
				. '<span class="meta-nav" aria-hidden="true">' . __( 'Anterior: ', 'learnpress' ) . '</span> <span class="screen-reader-text">' . __( 'Previous post:', 'learnpress' ) . '</span> <span class="post-title">' . $nav['back']['title'] . '</span></a>
					</div>';
		}
		if ( isset( $nav['next']['link'] ) ) {
			$nav_html .=
				...
				. '<span class="meta-nav" aria-hidden="true">' . __( 'Próxima: ', 'learnpress' ) . '</span> <span class="screen-reader-text">' . __( 'Next post:', 'learnpress' ) . '</span> <span class="post-title">' . $nav['next']['title'] . '</span></a>
					</div>
					';
		}
		$nav_html .= '
