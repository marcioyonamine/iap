...
class LP_Featured_Course_Widget extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array(
            'classname' => 'featured_course_widget',
            'description' => 'Display featured courses',
        );

        $this->widget_path = LP_PLUGIN_PATH . '/inc/widgets/featured_courses';
        ...
        parent::__construct( 'featured_course_widget', __('Featured Courses', 'leanpress'), $widget_ops );
    }
